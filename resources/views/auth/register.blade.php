...
<head>
  ...
  <link rel ="stylesheet" href="{{ asset('diseño/estilo.css')}}">
</head>

<body >
<section class="h-100 gradient-form" style="background-color: #eee;" center>
            ...
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  <img src="{{asset('diseño/logo.jfif')}}" 
                    style="width: 185px;" alt="logo">
                  <h4 class="mt-1 mb-5 pb-1">Registrar Datos  </h4>
                </div>
